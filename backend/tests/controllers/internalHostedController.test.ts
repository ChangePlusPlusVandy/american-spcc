...
describe('InternalHostedResourceController', () => {
  ...
  describe('createInternalHostedResource', () => {
    it('should create an internally hosted resource successfully with labels', async () => {
      ...
      expect(prismaMock.internalHostedResources.create).toHaveBeenCalledWith(
    ...
    it('should handle errors during creation', async () => {
      prismaMock.internalHostedResources.create.mockRejectedValue(new Error('Create failed'));
  ...
  describe('getAllInternalHostedResources', () => {
    it('should return all internal hosted resources', async () => {
      prismaMock.internalHostedResources.findMany.mockResolvedValue([
      ...
      expect(prismaMock.internalHostedResources.findMany).toHaveBeenCalled();
      expect(res.json).toHaveBeenCalledWith(
    ...
    it('should filter internal hosted resources by category', async () => {
      ...
      expect(prismaMock.internalHostedResources.findMany).toHaveBeenCalledWith(
    ...
    it('should handle Prisma errors', async () => {
      prismaMock.internalHostedResources.findMany.mockRejectedValue(new Error('Fetch failed'));
      const req = mockReq();
      const res = mockRes();
  ...
  describe('getInternalHostedResourceById', () => {
    it('should return a internal hosted resource if found', async () => {
      ...
      prismaMock.internalHostedResources.findUnique.mockResolvedValue(mockResource as any);
      ...
      expect(prismaMock.internalHostedResources.findUnique).toHaveBeenCalledWith({
        where: { id: 'ckres3333' },
    ...
    it('should return 404 if internal hosted resource not found', async () => {
      prismaMock.internalHostedResources.findUnique.mockResolvedValue(null);
  ...
  describe('updateInternalHostedResource', () => {
    it('should update a internal hosted resource successfully', async () => {
      prismaMock.internalHostedResources.update.mockResolvedValue({
        id: 'ckres4444',
        title: 'Updated Title',
      } as any);
      ...
      expect(prismaMock.internalHostedResources.update).toHaveBeenCalledWith(
        expect.objectContaining({
          where: { id: 'ckres4444' },
    ...
    it('should handle errors during update', async () => {
      prismaMock.internalHostedResources.update.mockRejectedValue(new Error('Update failed'));
  ...
  describe('deleteInternalHostedResource', () => {
    it('should delete a internal hosted resource successfully', async () => {
      prismaMock.internalHostedResources.delete.mockResolvedValue({ id: 'ckres5555' } as any);
      ...
      expect(prismaMock.internalHostedResources.delete).toHaveBeenCalledWith({
        where: { id: 'ckres5555' },
      });
      expect(res.json).toHaveBeenCalledWith(
    ...
    it('should handle errors during delete', async () => {
      prismaMock.internalHostedResources.delete.mockRejectedValue(new Error('Delete failed'));
